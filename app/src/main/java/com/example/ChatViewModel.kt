...
class ChatViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun buildSystemInstruction(settings: AppSettings, mode: com.example.ui.ChatMode): String {
...
7. If tool capabilities are enabled, actively utilize them (e.g., zip creation)
   ...
   copy-paste dozens of files manually."""
        ...
        val modePrompt = when(mode) {
            com.example.ui.ChatMode.QUICK -> quickPrompt
            com.example.ui.ChatMode.THINKING -> thinkingPrompt
            com.example.ui.ChatMode.CODING -> codingPrompt
        }
    ...
    fun sendMessage(content: String, mode: com.example.ui.ChatMode = com.example.ui.ChatMode.QUICK, attachedUris: List<android.net.Uri> = emptyList()) {
