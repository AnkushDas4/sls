...
import com.sednium.localspaces.ui.ChatScreen
import com.sednium.localspaces.ui.SettingsScreen
import com.sednium.localspaces.ui.theme.MyApplicationTheme
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      MyApplicationTheme(darkTheme = isDarkTheme, dynamicColor = settings.enableDynamicColor) {
        com.sednium.localspaces.ui.ErrorBoundary {
          ...
          when (currentScreen) {
              ...
              "model_resources" -> com.sednium.localspaces.ui.ModelResourcesScreen(
